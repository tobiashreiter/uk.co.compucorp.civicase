 ...
 */
class CRM_Civicase_Form_Report_Case_CaseWithActivityPivot extends CRM_Civicase_Form_Report_ExtendedReport {
  ...
  public function __construct() {
    ...
    $this->_columns = $this->getColumns('Case', array(
      ...
      + $this->getColumns('Contact', array('prefix_label' => 'Case Client-'))
